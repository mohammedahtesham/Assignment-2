<div class="container">
   ...
   <?php $this->session->unset_userdata('Error'); }  ?>
    ...
    <form action="<?php echo base_url(); ?>index.php/admin/processOrder" method="post" name="processOrder" id="processOrder">
    <div class="row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <div class="row">
                ...
                <label class=" alert-danger"><?php echo form_error('state'); ?></label>
            </div><br/>
            <div class="row">
                <div class="col-lg-6 col-lg-offset-2">
             ...
             <div class="row">
                <div class="col-lg-6 col-lg-offset-2">
                 ...
                 <label class=" alert-danger"><?php echo form_error('phone'); ?></label>
            </div><br/>
             <div class="row">
                <div class="col-lg-6 col-lg-offset-2">
                 ...
                 <label class=" alert-danger"><?php echo form_error('pin'); ?></label>
            </div><br/>
            <div class="row">
                <div class="col-lg-6 col-lg-offset-2">
                    <label>E-mail *</label>
                ...
                <label class=" alert-danger"><?php echo form_error('email'); ?></label>
            </div>
            <div class="row">
                <div class="col-lg-6 col-lg-offset-2">
                    <label>Address </label>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 ">
            <a href="<?php base_url();?>/index.php/admin" name="cancel" id="cancel" class="btn btn-default btn-danger">Cancel Order</a>
        </div>
    </div>
    ...
    $(function(){
       $("#state").change(function(){
         if($(this).val()!=0){
            ...
            var taxAmt  =   0;
            $.ajax({
               url:"<?php echo base_url(); ?>index.php/admin/ajaxState" ,
               data:data,
               type:'POST',
